...
# Import reverse_lazy instead of reverse
from django.urls import reverse_lazy

# Use reverse_lazy for all URL lookups in this file
apis = [
    {
        "name": "Health Check",
        "description": "Verify that the API server is up and responding.",
        "url": reverse_lazy("api:health_check"),
        "methods": [
            {
                "method": "GET",
                "params": None,
...
"""
    ...
    },
    {
        ...
        "url": reverse_lazy("api:add_collection"),
        "methods": [
            {
                "method": "POST",
                "body": """
