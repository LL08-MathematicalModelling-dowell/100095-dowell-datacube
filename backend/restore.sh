...
2. assign permissions using this command 'chmod +x restore.sh'

-------- RUN SCRIPT WITHIN THE PROJECT ------------------
1. move to the project directory
2. use './restore.sh' to run script

--------- RUN SCRIPT USING CRONTAB in UBUNTU -------------
1. open terminal and write crontab -e
2. write this line '15 12 * * * cd /path/to/project  && ./restore.sh'
3. above cronjob will run at 12:15 pm.
