...
const LandingPage = () => {
  ...
  // useEffect(() => {
  //   fetch("https://api.github.com/repos/yourusername/datacube")
  //     .then(r => r.json())
...
// import { Link } from "react-router-dom";
// import { Moon, Sun, ChevronRight, Check, Zap, Shield, Rocket } from "lucide-react";

// const testimonials = [
//   { name: "Alex Chen", role: "CTO @ Stealth Startup", text: "DataCube saved us 3 months of infra work. We shipped in 2 weeks." },
//   { name: "Sarah Kim", role: "Full-Stack @ Fintech", text: "Best dev experience I've had with a database. Period." },
//   { name: "Marcus Johnson", role: "Indie Hacker", text: "From zero to 10k users in a weekend. Thank you DataCube." },
// ];

// const PricingTier = ({ title, price, features, popular }: any) => (
//   <motion.div
//     whileHover={{ y: -8 }}
//     className={`relative p-8 rounded-2xl border ${
//       popular
//         ? "border-[var(--green-dark)] bg-[var(--green-dark)]/10 shadow-2xl shadow-[var(--green-dark)]/20"
//         : "border-[var(--border-color)] bg-[var(--bg-dark-2)]"
//     }`}
//   >
//     {popular && (
//       <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[var(--green-dark)] text-white px-4 py-1 rounded-full text-sm font-bold">
//         Most Popular
//       </div>
//     )}
//     <h3 className="text-2xl font-bold text-[var(--green-dark)] mb-2">{title}</h3>
//     <div className="mb-6">
//       <span className="text-5xl font-bold text-[var(--text-light)]">${price}</span>
//       <span className="text-[var(--text-muted)]">/month</span>
//     </div>
//     <ul className="space-y-3 mb-8">
//       {features.map((f: string) => (
//         <li key={f} className="flex items-center gap-3">
//           <Check className="w-5 h-5 text-[var(--green-dark)]" />
//           <span>{f}</span>
//         </li>
//       ))}
//     </ul>
...
//       }`}
//     >
//       {popular ? "Start Building" : "Get Started"}
//     </Link>
//   </motion.div>
// );
...
//       <button
//         onClick={() => setIsDark(!isDark)}
//         className="fixed top-6 right-6 z-50 p-3 rounded-full bg-[var(--bg-dark-3)] border border-[var(--border-color)] hover:border-[var(--green-dark)] transition-all"
//         aria-label="Toggle dark mode"
//       >
...
//         >
//           <h1 className="text-6xl sm:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[var(--green-dark)] to-[var(--green-dark)]/70 mb-6">
//             DataCube
//           </h1>
//           <motion.p
//             initial={{ opacity: 0 }}
...
//             className="text-2xl sm:text-4xl text-[var(--text-muted)] mb-8"
//           >
//             The Database That Doesn't Get in Your Way
//           </motion.p>
//           <motion.p
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             transition={{ delay: 0.5 }}
//             className="text-xl text-[var(--text-light)] mb-12 max-w-3xl mx-auto leading-relaxed"
//           >
//             MongoDB-like API. Zero ops. Instant scaling. Built for developers who want to ship fast — not manage servers.
//           </motion.p>
...
//             <Link
//               to="/register"
//               className="group inline-flex items-center gap-3 bg-[var(--green-dark)] hover:bg-[var(--green-dark)]/90 text-white px-10 py-5 rounded-xl text-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-2xl"
//             >
//               Start Free Now
...
//             <Link
//               to="/api-docs"
//               className="inline-flex items-center gap-3 border-2 border-[var(--green-dark)] text-[var(--green-dark)] hover:bg-[var(--green-dark)]/10 px-10 py-5 rounded-xl text-xl font-bold transition-all duration-300"
//             >
...
//       {/* Features */}
//       <section className="py-20 px-6 bg-[var(--bg-dark-2)]/50">
//         <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
//           {[
//             { icon: Rocket, title: "Deploy in Seconds", desc: "No servers. No DevOps. Just code." },
//             { icon: Shield, title: "JWT + API Keys", desc: "Secure by default. You own your data." },
//             { icon: Zap, title: "Blazing Fast", desc: "Sub-millisecond reads. Global edge cache." },
//           ].map((f, i) => (
//             <motion.div
//               key={i}
//               initial={{ opacity: 0, y: 30 }}
...
//             >
//               <f.icon className="w-16 h-16 mx-auto mb-6 text-[var(--green-dark)]" />
//               <h3 className="text-2xl font-bold mb-3">{f.title}</h3>
//               <p className="text-[var(--text-muted)] text-lg">{f.desc}</p>
//             </motion.div>
//           ))}
//         </div>
//       </section>
...
//           <p className="text-xl text-[var(--text-muted)]">Everything you need. Nothing you don't.</p>
//         </div>
...
//       <section className="py-20 px-6 bg-[var(--bg-dark-2)]/50">
//         <div className="max-w-4xl mx-auto text-center">
//           <h2 className="text-4xl font-bold mb-12">Loved by Developers</h2>
//           <motion.div
...
//             className="bg-[var(--bg-dark-2)] p-10 rounded-2xl border border-[var(--border-color)]"
//           >
...
//           Join thousands of developers already using DataCube.
//         </p>
//         <Link
//           to="/register"
//           className="inline-flex items-center gap-4 bg-[var(--green-dark)] hover:bg-[var(--green-dark)]/90 text-white px-12 py-6 rounded-xl text-2xl font-bold transition-all duration-300 transform hover:scale-105 shadow-2xl"
//         >
//           Start Free Today
...
//       <footer className="py-10 text-center text-[var(--text-muted)] border-t border-[var(--border-color)]">
//         © 2025 DataCube. Made with <span className="text-red-500">♥</span> for developers.
//       </footer>
//     </div>
//   );
// };
