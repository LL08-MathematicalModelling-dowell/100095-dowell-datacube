...
# --- Ephemeral playground sessions (/try) ---
PLAYGROUND_ENABLED = os.getenv("PLAYGROUND_ENABLED", "").lower() in ("1", "true", "yes")
PLAYGROUND_SESSION_TTL_HOURS = int(os.getenv("PLAYGROUND_SESSION_TTL_HOURS", "3"))
PLAYGROUND_MAX_ACTIVE_SESSIONS = int(os.getenv("PLAYGROUND_MAX_ACTIVE_SESSIONS", "500"))
PLAYGROUND_MAX_SESSIONS_PER_IP = int(os.getenv("PLAYGROUND_MAX_SESSIONS_PER_IP", "3"))
PLAYGROUND_START_ATTEMPTS_PER_HOUR = int(os.getenv("PLAYGROUND_START_ATTEMPTS_PER_HOUR", "20"))
PLAYGROUND_MAX_DATABASES = int(os.getenv("PLAYGROUND_MAX_DATABASES", "1"))
PLAYGROUND_MAX_COLLECTIONS = int(os.getenv("PLAYGROUND_MAX_COLLECTIONS", "3"))
PLAYGROUND_MAX_DOCUMENTS = int(os.getenv("PLAYGROUND_MAX_DOCUMENTS", "100"))
PLAYGROUND_COOKIE_MAX_AGE_SECONDS = int(
    os.getenv("PLAYGROUND_COOKIE_MAX_AGE_SECONDS", str(30 * 24 * 3600))
)
